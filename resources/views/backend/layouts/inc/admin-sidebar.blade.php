            ...
            <li class="nav-item">
                <div class=" " id="pagesExamples">
                    <ul class="nav border-start ms-4">
                        <li class="nav-item ">
                            <a class="nav-link text-white opacity-9 " href="{{ route('admin-dashboard') }}">
                                <span class="sidenav-mini-icon"> D </span>
                                <span class="sidenav-normal"> Dashboard </span>
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link text-white opacity-9 " href="{{ route('compayList') }}">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link text-white opacity-9 " href="{{ route('blogs') }}">
                                <span class="sidenav-mini-icon"> C </span>
                                <span class="sidenav-normal"> Blogs </span>
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link text-white opacity-9 " href="../../pages/pages/charts.html">
                                <span class="sidenav-mini-icon"> C </span>
                        ...
                        <li class="nav-item ">
                            <a class="nav-link text-white opacity-9 " href="{{ route('admin-logout') }}">
                                <span class="sidenav-mini-icon"> C </span>
