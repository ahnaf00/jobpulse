...
id="navbarBlur">
    <div class="container px-2 py-1 min-w-100">
        <nav aria-label="breadcrumb">
            ...
            <h5 class="mb-0 font-weight-bold breadcrumb-text  text-dark ">@yield('title')</h5>
        </nav>
            ...
            <ul class="navbar-nav  justify-content-end">
                    ...
                    <ul class="px-2 py-3 dropdown-menu dropdown-menu-end me-sm-n4" aria-labelledby="dropdownMenuButton">
                        <li class="mb-2">
                            <a class="dropdown-item border-radius-md" href="javascript:;">
                                <div class="py-1 d-flex">
                                    <div class="my-auto">
                                        <img src="{{ asset('assets/backend') }}/img/team-2.jpg"
                        ...
                        <li class="mb-2">
                            <a class="dropdown-item border-radius-md" href="javascript:;">
                                <div class="py-1 d-flex">
                                    <div class="my-auto">
                                        <img src="{{ asset('assets/backend') }}/img/small-logos/logo-spotify.svg"
                ...
                <li class="nav-item dropdown d-flex align-items-center">
                    <div class="avatar avatar-sm position-relative">
                        <img src="{{ asset('assets/backend') }}/img/team-1.jpg" alt="profile_image"
