            ...
            <div class="px-3 mb-3 row">
                <div class="col-6">
                    <div class="btn-group" role="tablist">
                        <input class="btn-check active" type="radio" name="radiotable" id="radiotable1"
                            autocomplete="off" role="tab" aria-controls="table1" aria-selected="true"
                            checked="">
                        <label class="px-4 mb-0 btn btn-white" for="radiotable1">View All</label>
                        <input class="btn-check active" type="radio" name="radiotable" id="radiotable2"
                            autocomplete="off" role="tab" aria-controls="table2" aria-selected="false">
                        <label class="px-4 mb-0 btn btn-white" for="radiotable2">Monitored</label>
                        <input class="btn-check active" type="radio" name="radiotable" id="radiotable3"
                            autocomplete="off" role="tab" aria-controls="table3" aria-selected="false">
                ...
                <table class="table mb-0 align-items-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-sm align-middle">
                                <span
                                    class="border badge border-radius-lg border-secondary opacity-7 text-secondary bg-secondary">Inactive</span>
                            </td>
                            <td class="align-middle">
                        ...
                        <tr>
                            ...
                            <td class="text-sm align-middle">
                                <span
                                    class="border badge border-radius-lg border-success opacity-7 text-success bg-success">Active</span>
                            </td>
                            <td class="align-middle">
